...
Ant Design 的 Modal 在桌面级复杂交互中存在不足：无法拖拽移动遮挡了背后的关键信息、无法全屏查看长内容、关闭弹窗后表单数据全部丢失需要重新填写。MyUI Modal 通过内置拖拽、最大化、最小化悬浮窗三大能力，将弹窗升级为真正的桌面级工作窗口，且最小化时 DOM 不销毁，完美保留表单状态。
