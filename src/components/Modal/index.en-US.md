...
| `onMaximizeChange`  | Callback fired when maximized state changes                                                         | `(maximized: boolean) => void`                                                                           | -                |
| `onMaximizedChange` | Callback fired when maximized state changes (alias of `onMaximizeChange`)                           | `(maximized: boolean) => void`                                                                           | -                |
